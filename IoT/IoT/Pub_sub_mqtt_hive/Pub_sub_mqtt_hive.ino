...
void reconnect()
{
    ...
    while(!client.connected()){
      ...
      if(client.connect("Sarim Khan"))  // add client name
      {
        Serial.println("Connected");
        client.publish("sarim/dht/humidity","Connected!");
        //             topic              messagge
        client.subscribe("sarim/room1/led");
        //                topic
...
//      Serial.println(currentMillis);
      client.publish("sarim/dht/humidity",pub_str);
      delay(1000);
    }
    client.loop();
}
